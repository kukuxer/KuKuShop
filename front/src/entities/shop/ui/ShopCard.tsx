...
import {Shop} from "../model/types.ts";
...
export const ShopCard: React.FC<ShopCardProps> = ({shop, onImageClick}) => {
        ...
        >
            ...
            <div className="p-6">
                ...
                hover:from-purple-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
                                aria-label="PublicShopPage All Items"
                            >
                                <FaShoppingBag className="w-5 h-5"/>
                                <span>PublicShopPage</span>
                            </motion.button>
                        </Link>
                ...
                hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50"
                            aria-label="Contact PublicShopPage"
                        >
