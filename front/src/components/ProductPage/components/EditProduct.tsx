        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="w-full max-w-xs space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative border border-[#404040] rounded-lg bg-[#2A2A2A] hover:bg-[#333333] transition-colors duration-200">
          ...
          <div className="flex justify-between pt-4">
            ...
            {confirmDelete ? (
              <div className="flex flex-col space-y-2 bg-[#2A2A2A] p-4 rounded-lg w-full max-w-sm mx-auto">
