...
const HeroSection: React.FC = () => {
    ...
    const handleShopNow = (): void => {
        console.log("PublicShopPage Now clicked");
    };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg sm:text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
                        Discover a world of premium products curated just for you. PublicShopPage the latest trends and must-have
                        items from top brands around the globe.
                    </p>
