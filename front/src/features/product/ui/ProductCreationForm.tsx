            ...
            <div className="max-w-4xl mx-auto bg-gray-800 rounded-xl shadow-xl p-8 space-y-8">
                ...
                <span className="flex items-center flex-wrap gap-2">
                  ...
                  />
                            ...
                            {isOpen && (
                                <div
                                    className="absolute z-10 mt-1 w-full bg-gray-800 shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-purple-500 ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
