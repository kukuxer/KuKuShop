...
import {EmptyProductCarousel} from "../EmptyProductCarousel";
...
export const ProductCarousel: React.FC<ProductCarouselProps> = ({onLoaded}) => {
    ...
    return (
        <div className="bg-gray-900 pt-12 pb-60 px-4 sm:px-6 lg:px-8">
            ...
            >
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-3xl font-bold text-white mb-8 z-0">Featured Products</h2>
                                            ...
                                            >
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <span
                                                            className="text-purple-400 font-bold">${product.price}</span>
